...
class TestClinica(unittest.TestCase):
    def setUp(self):
        ...
        self.paciente = Paciente("Franco Furfuri", "12345678", "01/01/1990")
    ...
    def test_agendar_turno_exitoso(self):
        fecha = datetime.strptime("17/06/2025 09:00", "%d/%m/%Y %H:%M")  
        resultado = self.clinica.agendar_turno("12345678", "M001", "Clínica", fecha)
        self.assertFalse(resultado)  

        fecha = datetime.strptime("16/06/2025 09:00", "%d/%m/%Y %H:%M")  
        resultado = self.clinica.agendar_turno("12345678", "M001", "Clínica", fecha)
    ...
    def test_emitir_receta_valida(self):
        resultado = self.clinica.emitir_receta("12345678", "M001", ["Paracetamol", "Ibuprofeno"])
        self.assertTrue(resultado)

    def test_emitir_receta_sin_medicamentos(self):
        resultado = self.clinica.emitir_receta("12345678", "M001", [])
        self.assertFalse(resultado)
